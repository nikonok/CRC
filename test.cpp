...
public:
    ...
    static void base_crc_test_4() {
        ...
        CHECK( crc.get_crc_code() == 0x7, "CRC4(123456789) != 0x7" );
    }
    ...
    static void base_crc_test_8() {
        ...
        CHECK( crc.get_crc_code() == 0xA1, "CRC8(123456789) != 0xA1" );
    }
    ...
    static void base_crc_test_16() {
        ...
        ss >> crc;
        cout << crc << endl;
        CHECK( crc.get_crc_poly() == 0x1021, "CRC4 poly != 0x1021");
        CHECK( crc.get_crc_code() == 0x31C3, "CRC4(123456789) != 0x31C3" );
    }
    ...
    static void base_crc_test_32() {
        ...
        ss >> crc;
        cout << crc << endl;
        CHECK( crc.get_crc_poly() == 0x04C11DB7, "CRC4 poly != 0x04C11DB7");
        CHECK( crc.get_crc_code() == 0x765E7680, "CRC4(123456789) != 0x765E7680" );
    }
};
